...
<?php 
	...
	function mytheme_enqueue_style() {
		...
		wp_register_style('stylesheet', get_stylesheet_directory_uri() . '/assets/css/stylesheet.css?v=30', array( 'style' ));
		wp_register_style('responsive', get_stylesheet_directory_uri() . '/assets/css/responsive.css?v=31', array( 'stylesheet' ));
		...
		wp_register_style('cs-select', get_stylesheet_directory_uri() . '/assets/css/cs-select.css', array( 'stylesheet' ));
		wp_register_style('cs-skin-elastic', get_stylesheet_directory_uri() . '/assets/css/cs-skin-elastic.css', array( 'stylesheet' ));
		...
		wp_register_script('theme_ajax', get_stylesheet_directory_uri() . '/assets/js/theme_ajax.js?v=15', array('jquery'), '1.0.0', true);
		wp_localize_script( 'theme_ajax', 'theme_object', array(
			'category'		=> get_category_fn(),
			'tag'        	=> get_tags_fn(),
			'images'		=> array(
								'plus_sign' => get_stylesheet_directory_uri().'/assets/images/plus_sign.png',
								'pencil_sign' => get_stylesheet_directory_uri().'/assets/images/pencil_sign.png',
								'close_sign' => get_stylesheet_directory_uri().'/assets/images/close_sign.png'),
		...
		wp_register_script('fidvid', get_stylesheet_directory_uri() . '/assets/js/jquery.fitvids.js', array('jquery'), '1.0.0', true);
		...
		wp_register_script('drag_drop_js', get_stylesheet_directory_uri() . '/assets/js/multiupload.js?v=12', array('jquery'), '1.0.0', true);
		...
		wp_register_script('custom', get_stylesheet_directory_uri() . '/assets/js/custom.js?v=20', array('jquery'), '1.0.1', true);
	...
	function angular_scripts() {
		...
		wp_register_script('angular_app', get_stylesheet_directory_uri() . '/angular/app/app.js', array('jquery'), '1.0.0', true);
		...
		wp_register_script('angular_authctrl', get_stylesheet_directory_uri() . '/angular/app/authCtrl.js?v=18', array('jquery'), '1.0.1', true);
	...
	//echo get_option( 'get_current_date_time' );
	//die();
			...
			<div class="<?php echo $class; ?>">
				<ul>
					<li class="pro_list_image" data-value="recent_post">
						<div class="post_cat_img">
							<a href="<?php echo home_url(''); ?>"><?php get_image('recently_added_edited.jpg', '', '', 'Recently Added Edited');?></a>
						</div>
		...
		<div class="feed_post_refer_link"><?php
				$last_edited_user = $content_data['last_edited_user'][0];
					if( $last_edited_user ) {
						...
						if($time > 1499256801  ) {?>
							<p class="glf_update_date_<?php echo $post->ID; ?> glf_update_single dates_ago"><?php echo humanTiming($glf_date);?> at <?php echo date('g:i A',strtotime( $glf_update_system ));?> </p><?php
						} else {?>
	                        <p class="glf_update_date_<?php echo $post->ID; ?> glf_update_single dates_ago"><?php echo date( 'M d Y' ,strtotime($glf_date));?> at <?php echo date('g:i A',strtotime( $glf_update_system ));?> </p><?php
                        }
					} else {
						...
						if($time > 1499256801) {?>
							<p class="glf_update_date_<?php echo $post->ID; ?> glf_update_single dates_ago" <?php echo $style; ?>><?php echo humanTiming($post_glf_update);?> at <?php echo date('g:i A',strtotime(str_replace('00', '12', $glf_update_system)));?></p><?php
						} else {?>
	                        <p class="glf_update_date_<?php echo $post->ID; ?> glf_update_single dates_ago"><?php echo date( 'M d Y' ,strtotime($post_glf_update));?> at <?php echo date('g:i A',strtotime( $glf_update_system ));?> </p><?php
						}
					}?>
								...
								<form name="form_<?php echo $post->ID; ?>" method="post" action="" id="user_infor_bias_voting_form_<?php echo $post->ID; ?>"><?php
									if( $infermative_count == 0 ) { ?>
                                        <div class="infermative_tab">
                                            ...
                                            <a href="javascript:void(0);" class="rating_option infermative_action" onclick="rating_option(<?php echo $post->ID; ?>, 'infermative', '');"><?php get_image('plus_sign.png', 23, 23);?></a>
                                            <a href="javascript:void(0);" class="rating_option infermative_action_close" onclick="rating_option(<?php echo $post->ID; ?>, 'infermative', '');"><?php get_image('close_sign.png', 23, 23);?></a>
									...
									if( $bias_count == 0 ) { ?>
                                        <div class="bias_tab">
                                            <span>Bias</span>
                                            <a href="javascript:void(0);" class="rating_option bias_action" onclick="rating_option(<?php echo $post->ID; ?>, 'bias', '');"><?php get_image('plus_sign.png', 23, 23);?></a>
                                            <a href="javascript:void(0);" class="rating_option bias_action_close" onclick="rating_option(<?php echo $post->ID; ?>, 'bias', '');"><?php get_image('close_sign.png', 23, 23);?></a>
                                    ...
                                    //if( $infermative_count == 0 ) { ?>
                                        ...
                                        <form name="form_<?php echo $post->ID; ?>" method="post" action="" id="user_infor_voting_form_<?php echo $post->ID; ?>"><?php
                                            ...
                                            <div class="single_vote_informative_option">
                                                <span>Informative?</span>
                                                <a href="javascript:void(0);" class="rating_option infermative_action" onclick="rating_option_informative(<?php echo $post->ID; ?>, 'infermative', 'single');"><?php get_image('plus_sign.png', 23, 23);?></a>
                                                <a href="javascript:void(0);" class="rating_option infermative_action_close" onclick="rating_option_informative(<?php echo $post->ID; ?>, 'infermative', 'single');"><?php get_image('close_sign.png', 23, 23);?></a>
                                            ...
                                            if( $user_voting_hide_bias == 0 ) { ?>
                                                <div class="single_vote_bias_option">
                                                    <span>Bias?</span>
                                                    <a href="javascript:void(0);" class="rating_option bias_action" onclick="rating_option_informative(<?php echo $post->ID; ?>, 'bias', 'single');"><?php get_image('plus_sign.png', 23, 23);?></a>
                                                    <a href="javascript:void(0);" class="rating_option bias_action_close" onclick="rating_option_informative(<?php echo $post->ID; ?>, 'bias', 'single');"><?php get_image('close_sign.png', 23, 23);?></a>
											...
											//if( $bias_count == 0 ) { ?>
												<span class="bias_single_vote_post_option bias_single_vote_post_option_<?php echo $post->ID; ?>" style="display:none;"><?php
													...
													if( $user_voting_hide_infor == 0 ) { ?>
														<div class="single_vote_informative_option">
															<span>Informative?</span>
															<a href="javascript:void(0);" class="rating_option infermative_action" onclick="rating_option_bias(<?php echo $post->ID; ?>, 'bias', 'infermative', 'single');"><?php get_image('plus_sign.png', 23, 23);?></a>
															<a href="javascript:void(0);" class="rating_option infermative_action_close" onclick="rating_option_bias(<?php echo $post->ID; ?>, 'bias', 'infermative', 'single');"><?php get_image('close_sign.png', 23, 23);?></a>
													...
													if( $user_voting_hide_bias == 0 ) { ?>
														<div class="single_vote_bias_option">
															<span>Bias?</span>
															<a href="javascript:void(0);" class="rating_option bias_action" onclick="rating_option_bias(<?php echo $post->ID; ?>, 'bias', 'bias', 'single');"><?php get_image('plus_sign.png', 23, 23);?></a>
															<a href="javascript:void(0);" class="rating_option bias_action_close" onclick="rating_option_bias(<?php echo $post->ID; ?>, 'bias', 'bias', 'single');"><?php get_image('close_sign.png', 23, 23);?></a>
			...
			if( is_user_logged_in() ) {
				...
				if($user_post_edit ) {
					...
					$user_post_edit= str_replace(" : ",":",$user_post_edit); ?>
						<p class="hide-767">You edited on  <?php echo date('M d Y', strtotime($user_post_edit)); ?> at <?php echo date('g:i A', strtotime($user_post_edit_system)); ?> </p><?php
					...
					$user_post_create= str_replace(" : ",":",$user_post_create); ?>
						<p class="hide-767">You added on <?php echo date('M d Y', strtotime($user_post_create)); ?> at <?php echo date('g:i A', strtotime($user_post_create_system)); ?> </p><?php
				}
			}
			$terms_arr = array();
			...
			<div class="user_vote_result_section source_publish_date_<?php echo $post->ID; ?> hide-767" <?php echo $style; ?> >
				...
				$post_arr = $wpdb->get_results("SELECT vote_date FROM ".$wpdb->prefix."hyroglf_users_voting_for_articles WHERE article_id = ".$post->ID." AND user_id =".$current_user->ID." ORDER BY voting_id DESC" ); ?>				
				...
				<li><span>You rated as</span></li><?php
					...
					if( $option_1 && $option_2 ) { ?>
						<li class="user_vote_rating">and</li><?php
					}
					if( $option_2 ) { ?>
						<li class="user_vote_rating user_info_rated_source_<?php echo $post->ID; ?>"><?php echo $option_2; ?></li><?php
					} ?>
				</ul> on <?php echo date('M d Y', strtotime($post_arr[0]->vote_date)); ?> at <?php echo date('g:i A', strtotime($post_arr[0]->vote_date)); ?>
			</div><?php
				...
				if( $vote_date_arr ) {
					if( isset( $vote_date_arr[$post->ID] ) ) { ?>
						<p>Added to Favorites on <?php echo date('M d Y', strtotime($vote_date_arr[$post->ID])); ?> at <?php echo date('g:i A', strtotime($vote_date_arr[$post->ID])); ?></p><?php
					}
				}
			} ?>
	...
	function get_slide_image_and_video_single( $post_id ) {
		...
		if( $post_multi_image_arr[0] || $post_video ) { ?>
			<div class="single_post_image_section">
				<ul class="<?php if(count($post_multi_image_arr)> 1 || count($post_video)> 1 || ($post_multi_image_arr && $post_video) ){ echo 'single_post_multi_image_slide '; } else { echo "single_post_multi_image"; }?>" <?php if(count($post_multi_image_arr)> 1 || count($post_video)> 1 || ($post_multi_image_arr && $post_video)){?> style="display:none;" <?php }?>><?php
				...
				if( $post_video ) {
							...
							if(isset($explode[1])) {
								...
								if($explode[0] == 'youtube') {
									if(isset($explode_m[1])) {
										$url = str_replace('m.youtube.com/watch?v=','www.youtube.com/embed/',$url);
									} else {
					...
					<li>
						<a class="fancybox fancybox.iframe" rel="gallery<?php echo $post_id; ?>" href="<?php echo $post_video; ?>">
							<div class="post_list_video"><iframe src="<?php echo $post_video; ?>" width="100%" height="222"></iframe></div>
						</a>
					</li><?php
				} ?>
				</ul><?php
	...
	function social_sharing_buttons() {
		global $post;
			...
			$twitterURL = 'https://twitter.com/intent/tweet?url='.$crunchifyURL.'&text='.$crunchifyTitle.'&via=@b';
...
function logout_redirect_page() {
	if (!is_user_logged_in() && !empty( $_REQUEST['redirect_to']) ) {
		...
		wp_logout();
		$smart_redirect_to = wp_login_url();
		wp_safe_redirect( $smart_redirect_to );
		exit();
	}
}
...
if(is_user_logged_in()){
	...
	$user_ac_status = get_user_meta( $user_id, 'user_account','true');
	//echo $user_ac_status;
