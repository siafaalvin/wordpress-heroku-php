                ...
                <div class="wiki_right_top">
                       ...
                       <div class="single_edit_action">
                            <ul>
                                <li class="single_close_icon">
                                    <a href="javascript:void(0);" onclick="close_single_content('<?php echo home_url('/');?>');"><i class="fa fa-close fa-2x"></a>
                                </li>

                                <li class="single_plus_icon" style="display:none;">
                                    <a href="javascript:void(0);" onclick="show_single_content();"><i class="fa fa-plus fa-5x"></i></a>
                                </li>
                            </ul>
                      </div>
                    </div>
					<div class="post_single_content_section"><?php
                       ...
                       <?php /*?> <?php
                        ...
                        <div class="updated_user_section">
                           ...
                           <?php
							if( !$image_video ) { ?>
						<span class="single_edit_icon"><?php
							edit_post_link('<i class="fa fa-edit fa-5x"></i> ', '<span class="post-edit" id="'.$postid.'">', '</span>');
							?>
						</span><?php
						} ?>
					   ...
					   <?php
						...
						if(!is_user_logged_in()){?>
                        	<a href="<?php echo home_url('/login');?>"><i class="fa fa-plus fa-2x"></i></a><?php
						}?>
                       </div>
                       </div>
