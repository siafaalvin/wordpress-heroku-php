...
<?php 
	...
	function mytheme_enqueue_style() {
		...
		wp_register_style('stylesheet', get_stylesheet_directory_uri() . '/assets/css/stylesheet.css?v=99', array( 'style' ));
		wp_register_style('responsive', get_stylesheet_directory_uri() . '/assets/css/responsive.css?v=83', array( 'stylesheet' ));
		...
		wp_register_script('theme_ajax', get_stylesheet_directory_uri() . '/assets/js/theme_ajax.js?v=53', array('jquery'), '1.0.0', true);
		...
		wp_register_script('custom', get_stylesheet_directory_uri() . '/assets/js/custom.js?v=60', array('jquery'), '1.0.1', true);
	...
	function angular_scripts() {
		...
		wp_register_script('angular_authctrl', get_stylesheet_directory_uri() . '/angular/app/authCtrl.js?v=97', array('jquery'), '1.0.1', true);
