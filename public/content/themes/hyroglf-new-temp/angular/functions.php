...
<?php
	...
	function mytheme_enqueue_style() {
		...
		wp_register_style('stylesheet', get_stylesheet_directory_uri() . '/assets/css/stylesheet.css?v=100', array( 'style' ));
		...
		// wp_register_style('flickity-css', 'https://unpkg.com/flickity@2/dist/flickity.min.css', array( 'stylesheet'  ));
		...
		wp_register_script('flickity', 'https://unpkg.com/flickity@2/dist/flickity.pkgd.min.js', array('jquery'), '2.1.2', true;
	...
	function angular_scripts() {
		...
		wp_localize_script( 'angular_app', 'theme_obj', array(
			...
			'scroll_cat'	=> scroll_load_cat_in_sidebar()
			'menu_cat' => load_side_menu() //new new new new new
		) );
								...
								<form name="form_<?php echo $post->ID; ?>" method="post" action="" id="user_infor_bias_voting_form_<?php echo $post->ID; ?>"><?php
									if( $infermative_count == 0 ) { ?>
                                        <div class="infermative_tab">
                                            ...
                                            <a href="javascript:void(0);" class="rating_option infermative_action_close" onclick="rating_option(<?php echo $post->ID; ?>, 'infermative', '');"><i class="fa fa-close fa-2x"></i></a>
									...
									if( $bias_count == 0 ) { ?>
                                        <div class="bias_tab">
                                            ...
                                            <a href="javascript:void(0);" class="rating_option bias_action_close" onclick="rating_option(<?php echo $post->ID; ?>, 'bias', '');"><i class="fa fa-close fa-2x"></i></a>
                                    ...
                                    //if( $infermative_count == 0 ) { ?>
                                        ...
                                        <form name="form_<?php echo $post->ID; ?>" method="post" action="" id="user_infor_voting_form_<?php echo $post->ID; ?>"><?php
                                            ...
                                            <div class="single_vote_informative_option">
                                                ...
                                                <a href="javascript:void(0);" class="rating_option infermative_action_close" onclick="rating_option_informative(<?php echo $post->ID; ?>, 'infermative', 'single');"><i class="fa fa-close fa-2x"></i></a>
                                            ...
                                            if( $user_voting_hide_bias == 0 ) { ?>
                                                <div class="single_vote_bias_option">
                                                    ...
                                                    <a href="javascript:void(0);" class="rating_option bias_action_close" onclick="rating_option_informative(<?php echo $post->ID; ?>, 'bias', 'single');"><i class="fa fa-close fa-2x"></i></a>
												...
												<span class="bias_single_vote_post_option bias_single_vote_post_option_<?php echo $post->ID; ?>" style="display:none;"><?php
													...
													if( $user_voting_hide_infor == 0 ) { ?>
														<div class="single_vote_informative_option">
															...
															<a href="javascript:void(0);" class="rating_option infermative_action_close" onclick="rating_option_bias(<?php echo $post->ID; ?>, 'bias', 'infermative', 'single');"><i class="fa fa-close fa-2x"></i></a>
													...
													if( $user_voting_hide_bias == 0 ) { ?>
														<div class="single_vote_bias_option">
															...
															<a href="javascript:void(0);" class="rating_option bias_action_close" onclick="rating_option_bias(<?php echo $post->ID; ?>, 'bias', 'bias', 'single');"><i class="fa fa-close fa-2x"></i></a>
