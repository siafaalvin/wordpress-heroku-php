    ...
    <header><?php
    	if(of_get_option('logo')){?>
                ...
                <a href="<?php echo home_url('/'); ?>">
                	<img src="<?php echo of_get_option('logo');?>" alt="logo" width="" height="" />
									<div class="motto">
											<p>Summarizing Your World</p>
									</div>
                </a>
								<!-- Begin search form -->
               <div class="post_filter_text">
								 <!-- ADD DYNAMIC CATEGORY TITLE HERE-->
								<button class="ocs-trigger ocs-toggle ocs-toggle-menu ocs-trigger-sub"><p class="dyna-label">Categories</p><i class="fas fa-bars fa-4x dyna-label"></i></button>  <!-- ADD DYNAMIC CATEGORY TITLE HERE-->
								<!-- END DYNAMIC CATEGORY TITLE HERE-->
                    <div class="wiki_topbar_right header_logo_bottom">
                        <ul>
                            <li class="search_box_sub">
