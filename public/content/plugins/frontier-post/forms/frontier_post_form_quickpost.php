...
?>		
	...
	<?php
			...
			wp_dropdown_categories(array('taxonomy' => "category", 'id'=>$tmp_field_name, 'exclude' => $cats_excluded, 'hide_empty' => 0, 'name' => $tmp_input_field_name, 'orderby' => 'name', 'selected' => $cats_selected[0], 'hierarchical' => true, 'show_count' => true, 'show_option_none' => __("None", "frontier-post"), 'option_none_value' => '0','class' => 'frontier_post_dropdown cs-select cs-skin-elastic')); 
